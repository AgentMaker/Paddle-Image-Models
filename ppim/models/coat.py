...
class CoaT(nn.Layer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Class tokens.
        self.cls_token1 = add_parameter(self, paddle.zeros((1, 1, embed_dims[0])))
        self.cls_token2 = add_parameter(self, paddle.zeros((1, 1, embed_dims[1])))
        self.cls_token3 = add_parameter(self, paddle.zeros((1, 1, embed_dims[2])))
        self.cls_token4 = add_parameter(self, paddle.zeros((1, 1, embed_dims[3])))
